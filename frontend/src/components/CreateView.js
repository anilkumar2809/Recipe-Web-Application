...
export default function CreateView(props) {
  ...
  const [cooktime, setCookTime] = React.useState(null);
  const [preptime, setPrepTime] = React.useState(null);
  const [servings, setServings] = React.useState(null);
  const [ingredients, setIngredients] = React.useState([{id: 0, value:null}]);
  const [steps, setSteps] = React.useState([{id: 1, value:null}]);
  ...
  React.useEffect(() => {
    ...
    setPrepTime(null);
    setServings(null);
    setIngredients([{id: 0, value:null}]);
    setSteps([{id: 1, value:null}]);
  },[open]);
  ...
  const handleSubmit = (event) => {
    ...
    const promise = createRecipe(newRecipe);
    promise.then(confirmCreation);
  }
